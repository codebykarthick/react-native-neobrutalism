...
/**
 * Content container for the AlertDialog modal.
 *
 * @example
 * ```tsx
 * <AlertDialogContent>
...
export function AlertDialogContent({
  ...
  animationType = 'fade',
  accessibilityLabel,
}: AlertDialogContentProps): JSX.Element | null {
  const { open, setOpen, themeOverride } = useAlertDialogContext();
  ...
  return (
    ...
    >
      <Pressable
        ...
        onPress={() => {
          // AlertDialog should not close on backdrop press by default
          // (unlike regular Dialog) as it requires user action
        }}
      >
        <Pressable
